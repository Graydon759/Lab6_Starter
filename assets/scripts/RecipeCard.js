...
class RecipeCard extends HTMLElement {
	...
	constructor() {
		...
		this.shadowDOM.appendChild(article);
	}
	...
	set data(data) {
		...
		const art = this.shadowDOM.querySelector('article');
		...
		art.innerHTML = `
			...
			<div class="rating">
				<span>5</span>
				<img src="/Users/graydon/Code/Lab 6/Lab6_Starter/assets/images/icons/${data.rating}-star.svg alt="${data.rating} stars">
